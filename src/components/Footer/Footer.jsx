  ...
  return (
    <div className="w-full h-screen bg-zinc-900 p-20 flex">
      <div className="w-1/2 flex flex-col justify-between h-full">
        <div>
          <h1 className="text-[5vw] uppercase leading-none ">Eye-</h1>
          <h1 className="text-[5vw] uppercase leading-none ">OPENING</h1>
        </div>
        <div>
          <svg
            width="72"
      ...
      <div className="w-1/2">
        <div>
          <h1 className="text-[5vw] uppercase leading-none ">presentations</h1>

          <div className="dets mt-10">
            <a className="block text-xl font-light">Facebook</a>
            <a className="block text-xl font-light">Instagram</a>
            <a className="block text-xl font-light">Facebook</a>
            <a className="block text-xl font-light">twitter</a>
          </div>
        </div>
      </div>
    </div>
